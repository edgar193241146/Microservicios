...
public class MotoController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Moto> actualizarUsuario(@RequestBody Moto moto, @PathVariable int id){
		try {
			Moto motoActual = motoService.getMotoById(id);
			motoActual.setMarca(moto.getMarca());
			motoActual.setModelo(moto.getModelo());
			motoActual.setUsuarioId(moto.getUsuarioId());
			
			motoService.save(motoActual);
	...
	@DeleteMapping("/{id}")
	public void eliminarMoto(@PathVariable int id) {
